...
[CreateAssetMenu(fileName = "Monster_A_Constant Data", menuName = "Scriptable Object/Monster_A_Constant Data", order = int.MaxValue)]
public class Monster_aconstant : ScriptableObject
{
    [SerializeField]
    private int Def;
